...
<html>
  ...
  <body>
<form id="pagerForm" method="post" action="caiwumethod!caiwulist4">
...
<div class="pageHeader">
	...
	<form onsubmit="return navTabSearch(this);" action="caiwumethod!caiwulist4" method="post">
	<div class="searchBar">
	...
	<table class="table" width="100%" layoutH="138">
		...
		<tbody>
			...
			<tr target="sid_user" rel="${bean.id}">
				...
				<td>
				${bean.churuku.shangpingming}
				</td>
				<td>
				${bean.churuku.shuliang}
				</td>
		
				<td>
				${bean.churuku.zhanyongmianji}
				</td>
				<td>
				${fn:substring(bean.churuku.createtime,0, 19)}
				</td>
