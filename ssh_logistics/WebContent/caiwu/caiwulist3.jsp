...
<html>
  ...
  <body>
<form id="pagerForm" method="post" action="caiwumethod!caiwulist3">
...
<div class="pageHeader">
	...
	<form onsubmit="return navTabSearch(this);" action="caiwumethod!caiwulist3" method="post">
	<div class="searchBar">
